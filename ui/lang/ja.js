...
(function () {
  const L = { nom: '日本語', ui: {
    ...
    'blk.grace': '猶予時間',
    'upd.readyManual': '✅ <b>アップデートの準備完了</b> — 「再起動して適用」をクリック（自動インストールはオフ）。',
    'upd.readyWaiting': '✅ <b>アップデートの準備完了</b> — できしだい自動で入る。<br><span style="opacity:.75">待っているもの：{list}。</span> いますぐ適用してもいい。',
    'upd.readySoon': '✅ <b>アップデートの準備完了</b> — まもなく自動でインストール…',
