...
(function () {
  const L = { nom: 'Türkçe', ui: {
    ...
    'upd.readyManual': '✅ <b>Güncelleme hazır</b> — "Yeniden başlat & uygula" düğmesine tıkla (otomatik kurulum kapalı).',
    'upd.readyWaiting': '✅ <b>Güncelleme hazır</b> — mümkün olur olmaz kendi kendine kurulacak.<br><span style="opacity:.75">Beklenen: {list}.</span> İstersen şimdi de uygulayabilirsin.',
    'upd.readySoon': '✅ <b>Güncelleme hazır</b> — otomatik kurulum birazdan başlıyor…',
