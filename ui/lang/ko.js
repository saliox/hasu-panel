...
(function () {
  const L = { nom: '한국어', ui: {
    ...
    'blk.window': '창 열림',
    'blk.grace': '유예 시간',
    'upd.readyManual': '✅ <b>업데이트 준비 완료</b> — ‘재시작 & 적용’을 누르세요 (자동 설치 꺼짐).',
    'upd.readyWaiting': '✅ <b>업데이트 준비 완료</b> — 가능해지는 대로 알아서 설치돼요.<br><span style="opacity:.75">기다리는 중: {list}.</span> 지금 바로 적용해도 돼요.',
    'upd.readySoon': '✅ <b>업데이트 준비 완료</b> — 곧 자동으로 설치돼요…',
  ...
  <h3>🔋 가벼운 자원 사용</h3>
  <p>패널은 24시간 내내 티 안 나게 돌아가요: <b>알림 영역에 접어두면</b> <b>감시를 느리게</b> 하고 아무도 안 보는 화면 계산을 멈춰요. 창을 다시 열면 전부 즉시 돌아와요. (게임 모드나 인터넷 사용 줄이기가 작동 중이면 놓치는 게 없도록 계속 반응해요.)</p>
  <h3>🎮 내 Discord 상태</h3>
