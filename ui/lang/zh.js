...
(function () {
  const L = { nom: '简体中文', ui: {
    ...
    'blk.window': '窗口开着',
    'blk.grace': '等待缓冲时间',
    'upd.readyManual': '✅ <b>更新已就绪</b> — 点「重启并应用」（自动安装已关闭）。',
    'upd.readyWaiting': '✅ <b>更新已就绪</b> — 它会尽快自己装好。<br><span style="opacity:.75">正在等：{list}。</span> 你也可以现在就应用。',
    'upd.readySoon': '✅ <b>更新已就绪</b> — 马上就会自动安装…',
    'set.lastScan': '（上次扫描：{d}）',
    'set.noScan': '（还没扫描过）',
